...
class ParkingRecord
{
    ...
    public function type(): VehicleType { return $this->type; }
    public function entryAt(): \DateTime { return $this->entryAt; }
    public function exitAt(): ?\DateTime { return $this->exitAt; }
